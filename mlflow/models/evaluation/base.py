    ...
    :param eval_fn:
        ...
        .. code-block:: python
            ...
            def eval_fn(
                ...
                input: Optional[pandas.Series] = None,
                **kwargs,
            ) -> Union[float, MetricValue]:
                """
                :param predictions: A pandas Series containing the predictions made by the model.
                :param targets: A pandas Series containing the corresponding labels for the
                    predictions made on that input.
                :param metrics: A dictionary containing the metrics calculated by the default evaluator.
                ...
                :param input: (Optional) A pandas Series containing the input sent to the model.
